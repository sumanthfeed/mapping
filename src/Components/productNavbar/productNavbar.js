...
const categoryModelOne = [
  ...
  {
    name: 'Value Added Units / Cold Storage',
    value: 'vad',
  ...
  {
    name: 'Ports - india & Global (Sea/IDC/Air)',
    value: 'portsIndiaGlobal',
    icon: '',
  },
  {
    name: 'Logistics - india & Global',
    value: 'logisticsIndiaGlobal',
    icon: '',
  },
]

const categoryModelTwo = [
  {
...
const categoryModelThree = [
  ...
  {
    name: 'Consignment Data',
    value: 'Consignment Data',
  },
  {
    name: 'Packing Guide',
    value: 'Packing Guide',
